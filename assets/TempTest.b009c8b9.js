var i=Object.defineProperty;var y=(o,t,e)=>t in o?i(o,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):o[t]=e;var c=(o,t,e)=>(y(o,typeof t!="symbol"?t+"":t,e),e);import{E as m}from"./elk.bundled.d59b6e15.js";import{g as u,o as f,c as g}from"./index.e8023ce0.js";class l{constructor(){c(this,"elk",new m({}))}getInterfaceName(t,e){return t+e.charAt(0)+e.slice(1).toLowerCase()}async GenerateLayoutOptionsTypes(){const t=await this.elk.knownLayoutOptions(),e="LayoutOptions",a=new Set;t.forEach(s=>{var n;(n=s.targets)==null||n.forEach(r=>a.add(r))});let p="";return a.forEach(s=>{p+=`export interface ${this.getInterfaceName(e,s)} {
...
`}),p+=`export interface ${e} extends ${[...a].map(s=>this.getInterfaceName(e,s)).join(", ")} {
    ...
    }`,p}}const E=u({__name:"TempTest",setup(o){return new l().GenerateLayoutOptionsTypes().then(e=>console.log(e)),(e,a)=>(f(),g("div",null,"Testseite f\xFCr tempor\xE4re Tests"))}});export{E as default};
